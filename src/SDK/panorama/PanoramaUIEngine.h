...
public:
    ...
    virtual void UnregisterForPanelDestroyed(); //CUtlDelegate<void ()(panorama::IUIPanel const*,panorama::IUIPanel*)>) = 0;//40
    ...
    virtual const char* GetApplicationUserDataPath(void) = 0;//60
